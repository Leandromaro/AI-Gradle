...
//                                        s.setText(textoAnterior);
                                ...
                                if("FINAL".equals(s.getText())){
                                    s.setBackground(Color.white);
                                    s.setText(textoAnterior);
                                    MainWindow.banderaEstadoFinal = false;
                                    MainWindow.jlAusenciaEstadoFinal.setVisible(true);
                                }
                                MainWindow.jbConfirmar.setVisible(true);
                                MainWindow.jbConfirmar.setEnabled(false);
                            }
                    }
                }     
            }
        ...
        if((MainWindow.estadoInicial) & (MainWindow.banderaEstadoFinal)){
            MainWindow.jbConfirmar.setEnabled(true);
        }
        this.jbEstado = s;
